import { Experience, Project, SkillCategory } from '@/lib/types';
...
export const projects: Project[] = [
	{
		...
		link: '',
		image: '/images/projects/ecommerce-saas.jpg',
	},
	{
		name: 'Virtual Event Platform',
		description: 'Event‑management SaaS adopted by the Canadian government for MWC 2025.',
		tech: ['.NET Core', 'Azure', 'MS SQL Server'],
		link: '',
		image: '/images/projects/virtual-event.jpg',
	},
	{
		name: 'Headless Checkout Experience',
		description: 'Blazing‑fast checkout that raised conversion by 20% for a major retailer.',
		tech: ['Next.js', 'Vercel'],
		link: '',
		image: '/images/projects/headless-checkout.jpg',
	},
	{
		name: 'Digital Asset Management Platform',
		description: 'Rich‑media activation platform built on a micro‑services architecture.',
		tech: ['React', 'Rust', 'gRPC', 'AWS'],
		link: '',
		image: '/images/projects/dam-platform.jpg',
	},
];
